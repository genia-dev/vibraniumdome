...
const basePolicy = {
  ...
  "output_shields": [
    ...
    { "type": "com.vibraniumdome.shield.output.sensitive_info_disc", "metadata": { "entities": ["CREDIT_CARD", "PERSON", "URL", "PHONE_NUMBER", "IP_ADDRESS", "EMAIL_ADDRESS", "DATE_TIME", "LOCATION", "US_PASSPORT", "US_BANK_NUMBER", "US_DRIVER_LICENSE"] }, "full_name": "PII and sensetive information disclosure shield" },
