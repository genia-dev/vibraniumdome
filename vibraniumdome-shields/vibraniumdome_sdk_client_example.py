...
def func_representation_as_json(func) -> str:
...
conversation = [
    ...
    {"role": "user", "content": "whats the weather right now?"},
]
...
weather_function_json = func_representation_as_json(get_current_weather)
